...
latex_documents = [
    (master_doc, 'aqua.tex', 'Aqua Documentation',
     'Jeff Thorne', 'manual'),
]
...
man_pages = [
    (master_doc, 'aqua', 'aqua Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aqua', 'aqua Documentation',
     author, 'aqua', 'One line description of project.',
     'Miscellaneous'),
]
